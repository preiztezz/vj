module ii_address_decoder (
    input  wire [3:0]  ii_reg_index,
    input  wire [5:0]  width_ii,
    input  wire [12:0] p_offset,

    input  wire [4:0]  x_rect0,
    input  wire [4:0]  x_rect1,
    input  wire [4:0]  x_rect2,

    input  wire [4:0]  y_rect0,
    input  wire [4:0]  y_rect1,
    input  wire [4:0]  y_rect2,

    input  wire [4:0]  w_rect0,
    input  wire [4:0]  w_rect1,
    input  wire [4:0]  w_rect2,

    input  wire [4:0]  h_rect0,
    input  wire [4:0]  h_rect1,
    input  wire [4:0]  h_rect2,

    output reg [12:0] ii_address
);
    ...
    always @(*) begin
        case (ii_reg_index)
            ...
            4'h0: ii_address = ii_address0;
            4'h1: ii_address = ii_address1;
            4'h2: ii_address = ii_address2;
            4'h3: ii_address = ii_address3;

            4'h4: ii_address = ii_address4;
            4'h5: ii_address = ii_address5;
            4'h6: ii_address = ii_address6;
            4'h7: ii_address = ii_address7;

            4'h8: ii_address = ii_address8;
            4'h9: ii_address = ii_address9;
            4'hA: ii_address = ii_address10;
            4'hB: ii_address = ii_address11;

            default: ii_address = ii_address0;
